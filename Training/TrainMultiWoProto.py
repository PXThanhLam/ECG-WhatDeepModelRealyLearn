...
from DataProcessing.LoadTrainData import Multidata_train_test 
from ModelArch.BackBone import MultiBackBoneNet,SingleBackBoneNet
...
def train(args,test_mode='intra',):
    ...
    model=MultiBackBoneNet(SingleBackBoneNet())
    ...
    for epoch in range(args.epochs):
        ...
        with torch.no_grad():
            val_data = Multidata_train_test(train_or_test='test',test_mode=test_mode)
